...
head(nwsid) 
nwsid <- nwsid %>% mutate(date_time = ymd(OBSDATE), date_time = lubridate::date(date_time))
tail(nwsid)
...
#not sure what this was for..pbly delete..saving for now..
#head(nwsid)
#tail(nwsid)
#
